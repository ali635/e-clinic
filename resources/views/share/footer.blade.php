<footer class="bg-gray-900">
    <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto tablet:px-6 web:px-8 web:pt-24">
            ...
            <div class="grid grid-cols-1 gap-8 tablet:grid-cols-2 web:col-span-2">
                ...
                <div class="text-center tablet:text-start">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a class="flex items-center justify-center tablet:justify-start gap-1.5 group"
                                href="mailto:{{ setting('site_email') }}">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5 text-white shrink-0 transition group-hover:text-primary"
                        ...
                        <li class="flex items-start justify-center gap-1.5 tablet:justify-start">

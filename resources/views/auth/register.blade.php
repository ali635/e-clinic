...
@section('content')
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        ...
        <div class="max-w-4xl w-full relative z-10">
            ...
            <form class="space-y-6 genericForm bg-white p-8 rounded-2xl shadow-xl border border-gray-200" method="POST" action="{{ route('patient.register.post') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2 lg:col-span-2">
                        <label for="marital_status" class="block text-sm font-semibold text-gray-800 flex items-center gap-2">
                            <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2 lg:col-span-2">
                        <label for="street" class="block text-sm font-semibold text-gray-800 flex items-center gap-2">
                            <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5A2.5 2.5 0 0013.5 5.5V3.935M7 3h10a2 2 0 012 2v2m-6 10h4a2 2 0 002-2v-2M7 17h4m-4 0a2 2 0 11-4 0m0 0V6a2 2 0 012-2h4a2 2 0 012 2v11m0 0a2 2 0 11-4 0"/>
                            </svg>
                            {{ __('Address') }}
                        </label>
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation" class="block text-sm font-semibold text-gray-800 flex items-center gap-2">
                            <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                            </svg>
                            {{ __('Confirm Password') }}
                    ...
                    <div class="space-y-2">
                        <label for="hear_about_us" class="block text-sm font-semibold text-gray-800 flex items-center gap-2">
                            <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <!-- Image Profile Field -->
                    <div class="space-y-2 lg:col-span-2">
                        <label for="img_profile" class="block text-sm font-semibold text-gray-800 flex items-center gap-2">
                            <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L12.929 16H16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                            </svg>
                            {{ __('Profile Image') }}
                        </label>
            ...
            <!-- Login Link -->
            <p class="mt-6 text-center text-sm text-gray-600 bg-white py-3 px-6 rounded-xl shadow-md border border-gray-200 max-w-md mx-auto">
                {{ __('Already have an account?') }}
                <a href="{{ route('patient.login') }}" class="font-semibold text-primary hover:text-primary/80 transition-colors duration-200">
                    {{ __('Sign in') }}
                </a>
            </p>
        </div>

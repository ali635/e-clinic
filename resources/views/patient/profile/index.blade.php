    ...
    <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div class="max-w-4xl mx-auto">
            <div id="profileDisplay"
                class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 sm:p-8 animate-fade-in">

                <!-- Profile Header -->
                <div
                    class="flex flex-col sm:flex-row items-center sm:items-center justify-between gap-6 pb-6 mb-6 border-b border-gray-200">
                        ...
                        <div class="flex-shrink-0">
                            <div class="relative">
                                <img onerror="if(!this.dataset.fallback){this.dataset.fallback=true;this.src='{{ asset(setting('site_logo')) }}';}else{this.onerror=null;}"
                                    src="{{ asset($patient->img_profile) }}" alt="{{ $patient->name }}"
                                    class="w-24 h-24 rounded-full object-cover ring-4 ring-primary/10 shadow-lg">
                                <div
                                    class="absolute -bottom-1 -right-1 w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold">
                    ...
                    <a href="{{ route('patient.profile.show.form') }}"
                        ...
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-4.036L15.732 3.732z" />
                        </svg>
                        {{ __('Edit Profile') }}
                    </a>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-4">
                            <div
                                class="flex items-center justify-between gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-150">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-4">
                            ...
                            <div
                                ...
                                <span
                                    class="text-sm font-medium text-gray-900 px-3 py-1 bg-white rounded-md shadow-sm text-right max-w-xs">
                                    {{ $patient->address ?? '-' }}
                                </span>
                            </div>
                        </div>

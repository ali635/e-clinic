                    ...
                    <ul class="space-y-6">
                        ...
                        <li>
                            <a href="{{ route('patient.dashboard') }}"
                                class="sidebarMenu_item @if (Route::currentRouteName() == 'patient.dashboard') active @endif">
                                <svg class="me-2" width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path
                        ...
                        <li>
                            <a href="{{ route('patient.visits') }}"
                                class="sidebarMenu_item @if (Route::currentRouteName() == 'patient.visits' || Route::currentRouteName() == 'patient.visits.show') active @endif">
                                <svg class="me-2" width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path
                        ...
                        <li>
                            <a href="{{ route('patient.history') }}"
                                class="sidebarMenu_item @if (Route::currentRouteName() == 'patient.history') active @endif">
                                <svg class="me-2" width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path

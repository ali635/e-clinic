...
<main class="flex-1 px-4 py-8 md:ml-0 ml-0 overflow-x-auto">
    ...
    <section class="bg-white rounded-xl shadow p-6 mb-6">
        <h2 class="text-lg font-semibold mb-3 text-primary flex items-center">
            <svg class="inline me-2" width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 11V17H13V11H11ZM11 7V9H13V7H11Z"></path></svg>
            Visit Details
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="mb-2">
                    ...
                    <!-- if arrived -->
                    <span class="text-primary font-bold">Yes</span>
    ...
    <section class="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div class="flex flex-wrap gap-4">
            <div class="w-32 h-32 rounded overflow-hidden border border-gray-200 flex items-center justify-center bg-gray-50 shadow">
                <a href="https://picsum.photos/200/300" data-lightbox="lab-tests">
                    <img src="https://picsum.photos/200/300" alt="Lab Test 1" class="max-w-full max-h-full object-cover">
                </a>
            </div>
            <div class="w-32 h-32 rounded overflow-hidden border border-gray-200 flex items-center justify-center bg-gray-50 shadow">
                <a href="https://picsum.photos/200/300" data-lightbox="lab-tests">
                    <img src="https://picsum.photos/200/300" alt="Lab Test 2" class="max-w-full max-h-full object-cover">
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div class="flex flex-wrap gap-4">
            <div class="w-32 h-32 rounded overflow-hidden border border-gray-200 flex items-center justify-center bg-gray-50 shadow">
                <a href="https://picsum.photos/400/500" data-lightbox="x-rays">
                    <img src="https://picsum.photos/400/500" alt="X-Ray 1" class="max-w-full max-h-full object-cover">
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div>
            ...
            <ul class="list-disc ms-6 text-primary mt-2 mb-0 text-sm space-y-1">
                <li>
                    <a href="#" class="underline hover:text-primary/60" target="_blank">blood-test-instructions.pdf</a>
                </li>
                <li>
                    <a href="#" class="underline hover:text-primary/60" target="_blank">insurance_card.jpg</a>
                </li>
            </ul>
        </div>
    </section>

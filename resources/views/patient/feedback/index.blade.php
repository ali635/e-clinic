                            ...
                            <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center">
                                        <div class="flex items-center gap-1 bg-yellow-50 px-3 py-2 rounded-full border border-yellow-200">
                                            @for ($i = 1; $i <= 5; $i++)
                                                <svg class="w-5 h-5 {{ $i <= $feedback->rating ? 'text-yellow-400' : 'text-gray-300' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-700">{{ __('No Feedback Found') }}</h3>
                                        <p class="text-gray-500 text-sm">{{ __('Your feedback will appear here after you rate services') }}</p>
                                    </div>
                                </div>
                            </td>
                        </tr>

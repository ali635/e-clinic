  ...
  <section class="relative h-[600px] overflow-hidden">
      ...
      <div class="absolute inset-0">
          <img src="{{ asset('images/medical_hero.png') }}" alt="Medical Care" class="w-full h-full object-cover">
          {{-- Gradient Overlay --}}
      ...
      <div class="container relative h-full flex items-center">
          <div class="max-w-2xl text-white">
              <h1 class="text-5xl tablet:text-6xl font-bold mb-6 leading-tight">
                  {{ __('Your Health, Our Priority') }}
              </h1>
              <p class="text-xl tablet:text-2xl mb-8 text-blue-50 leading-relaxed">
                  {{ __('Experience world-class medical care with our team of expert doctors. We provide comprehensive healthcare services tailored to your needs.') }}
              </p>

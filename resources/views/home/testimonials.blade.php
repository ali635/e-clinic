    ...
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 relative inline-block">
                ...
                <span class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-gradient-to-r from-primary to-primary/60 rounded-full"></span>
            </h2>
                ...
                @foreach($feedbacks as $feedback)
                    <div class="relative bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-200 overflow-hidden group reveal-up">
                        ...
                        <div class="flex items-center gap-4 mb-6 relative z-10">
                            <div class="w-14 h-14 rounded-full bg-gradient-to-br from-primary/10 to-primary/20 flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform duration-300">
                                <span class="text-primary text-xl font-bold">
                                    {{ strtoupper(substr($feedback->patient->name ?? 'P', 0, 1)) }}
                                </span>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h4 class="text-lg font-bold text-gray-900 truncate group-hover:text-primary transition-colors duration-300">
                        ...
                        <!-- Bottom Gradient Bar -->
                        <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </div>
                @endforeach
            </div>
        @else
            ...
            <div class="text-center py-16">
                <div class="bg-white/50 rounded-2xl p-12 backdrop-blur-sm">
                    <svg class="w-20 h-20 text-gray-300 mx-auto mb-6 opacity-50" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                    </svg>
                    <h3 class="text-2xl font-bold text-gray-700 mb-2">{{ __('No Testimonials Yet') }}</h3>
                    <p class="text-gray-500 text-lg max-w-md mx-auto">{{ __('Be the first to share your experience with us!') }}</p>
                </div>
            </div>
        @endif
    </div>

...
@section('content')
    ...
    <section class="relative h-[70vh] min-h-[500px] overflow-hidden">
        <img src="{{ asset($post->image) }}" alt="{{ $post->name }}" class="w-full h-full object-cover">
        ...
        <div class="absolute inset-0 flex items-center justify-center z-[2]">
            <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                <div class="max-w-4xl mx-auto">
                    <h1
                        class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight capitalize drop-shadow-lg">
                        {{ $post->name }}
                    </h1>

                    <!-- Blog Meta Information -->
                    <div
                        class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-white/90 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full w-max mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        <h3
                            class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2 pb-4 border-b border-primary/20">
                        ...
                        <div class="space-y-4">
                            ...
                            @if ($post->updated_at && $post->updated_at->ne($post->created_at))
                                <div class="flex items-start justify-between py-3 border-b border-gray-100">
                                    ...
                                    <div class="text-right">
                                        <div class="text-gray-900 font-semibold">{{ $post->updated_at->format('M d, Y') }}
                                        </div>

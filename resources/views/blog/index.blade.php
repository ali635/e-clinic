        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 relative inline-block">
                    {{ __('Blogs') }}
                    <span
                        class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-primary to-primary/60 rounded-full"></span>
                </h2>
                    ...
                    @if ($post->slug)
                        <article
                            ...
                            <div class="relative h-56 md:h-64 overflow-hidden">
                                ...
                                <!-- Date Badge -->
                                <div
                                    class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-sm">
                            ...
                            <div class="p-6 md:p-7">
                                <h3
                                    class="text-xl md:text-2xl font-bold mb-3 text-gray-900 group-hover:text-primary transition-colors duration-300 line-clamp-2">
                                    {{ $post->name }}
                                </h3>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="{{ route('post.show', $post->slug) }}"
                                        ...
                                        <span
                                            class="group-hover/read:translate-x-1 transition-transform duration-300">{{ __('View Article') }}</span>
                    ...
                    <div class="col-span-full">
                        <div class="bg-white rounded-2xl shadow-lg p-12 text-center border border-gray-200">
                            ...
                            <p class="text-gray-500 text-lg max-w-md mx-auto">
                                {{ __('Stay tuned! New articles will be published soon.') }}</p>
                        </div>
                    </div>
                @endforelse
            </div>

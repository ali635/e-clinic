    ...
    <section class="py-12 bg-white">
        <div class="container">
            ...
            <p class="text-center text-gray-600 mb-12 text-lg">
                {{ __('Here are our posts choose from them') }}
            </p>
                            ...
                            <div class="flex items-center justify-between">
                                @if ($post->slug)
                                    <a href="{{ route('post.show', $post->slug) }}"
                                        class="px-4 py-1 rounded-full hover:bg-primary text-white transition duration-300 ease-in-out bg-primary/60">{{ __('Discover') }}
                                    </a>
                                @endif
                            </div>
                        </div>
